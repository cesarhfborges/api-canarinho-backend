...
<div class="tocify-wrapper">
    ...
    <ul class="toc-footer" id="toc-footer">
        @if($metadata['postman_collection_url'])
            <li style="padding-bottom: 5px;"><a href="{!! $metadata['postman_collection_url'] !!}">Ver collection do Postman</a></li>
        @endif
        @if($metadata['openapi_spec_url'])
            <li style="padding-bottom: 5px;"><a href="{!! $metadata['openapi_spec_url'] !!}">Ver especificação OpenAPI</a></li>
        @endif
